package ru.indemion.carservice.annotations;
...
public class Configurator {
    ...
    private Properties loadProperties(String configFileName) {
        ...
        try (InputStream stream = Configurator.class.getClassLoader().getResourceAsStream(configFileName)) {
            if (stream == null) {
                throw new RuntimeException(configFileName + " не найден!");
            }
            props.load(stream);
        } catch (IOException e) {

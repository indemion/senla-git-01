...
import carservice4.common.Period;
...
public class Query extends carservice4.common.Query<Order> {
    ...
    public Query orderByCreatedAt(boolean ascending) {
        return (Query) addComparator(Comparator.comparing(Order::getCreatedAt,
                Comparator.nullsLast(Comparator.naturalOrder())), ascending);
    }

    public Query orderByActualWorkPeriodEnd(boolean ascending) {
        return (Query) addComparator(Comparator.comparing((Order order) -> order.getActualWorkPeriod().getEnd(),
                Comparator.nullsLast(Comparator.naturalOrder())), ascending);
    }

    public Query orderByEstimatedWorkPeriodStart(boolean ascending) {
        return (Query) addComparator(Comparator.comparing((Order order) -> order.getEstimatedWorkPeriod().getStart(),
                Comparator.nullsLast(Comparator.naturalOrder())), ascending);
    }
